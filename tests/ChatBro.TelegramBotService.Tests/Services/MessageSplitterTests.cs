...
public class MessageSplitterTests
{
    ...
    [Fact]
    public void SplitSmart_EmptyString_ThrowsArgumentException()
    {
        Assert.Throws<ArgumentException>(() => _splitter.SplitSmart("").ToList());
    }

    [Fact]
    public void SplitSmart_WhitespaceString_ThrowsArgumentException()
    {
        Assert.Throws<ArgumentException>(() => _splitter.SplitSmart("   \n\t  ").ToList());
    }
    ...
    public void SplitSmart_ShortMessage_ReturnsSinglePart()
    {
        ...
        var result = _splitter.SplitSmart(text).ToList();
    ...
    public void SplitSmart_MessageJustOverLimit_SplitsAtLimit()
    {
        ...
        var result = _splitter.SplitSmart(text, 4000, 3800).ToList();
